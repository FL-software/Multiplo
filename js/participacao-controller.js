$(function(){
    ...
    $("#inserir").click(function(){
        ...
        let idpartida = $("#inserir_id_partida").val();

        $.ajax({
            type:"POST",
            url:"participacao-model.php",
            data:"acao="+acao+"&ativo="+ativo+"&idpersonagemusuario="+idpersonagemusuario+"&idpartida="+idpartida,
    ...
    $("#alterar").click(function(){
        ...
        let idpartida = $("#editar_id_partida").val();

        $.ajax({
            type:"POST",
            url:"participacao-model.php",
            data:"acao="+acao+"&ID="+ID+"&ativo="+ativo+"&idpersonagemusuario="+idpersonagemusuario+"&idpartida="+idpartida,
            success: function(msg){
                alert(msg);
