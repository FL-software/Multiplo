$(function(){
    ...
    $("#inserir").click(function(){
        ...
        let idposicao = $("#inserir_id_posicao").val();

        $.ajax({
            type:"POST",
            url:"personagem-posicao-model.php",
            data:"acao="+acao+"&ativo="+ativo+"&idpersonagemusuario="+idpersonagemusuario+"&idposicao="+idposicao,
    ...
    $("#alterar").click(function(){
        ...
        let idposicao = $("#editar_id_posicao").val();

        $.ajax({
            type:"POST",
            url:"personagem-posicao-model.php",
            data:"acao="+acao+"&ID="+ID+"&ativo="+ativo+"&idpersonagemusuario="+idpersonagemusuario+"&idposicao="+idposicao,
            success: function(msg){
                alert(msg);
