...
<main role="main" class="container">
  <div class="container">
    <div class="bg-white p-5 rounded">
      <div class="row">
        <h1 class="col">Personagens do Usuário</h1>
      ...
      <table class="table" border="0" width="100%" align-items="center" margin="auto">
        ...
        <tbody>
          <?php
            ...
            $listar = $personagemUsuario -> listar();
          ?>
        </tbody>
      </table>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label for="">Personagem:</label><br>
        <select id="inserir_id_personagem">
          <option value="" selected disabled>-</option>
          <?php
            $opcoes = $personagemUsuario -> listar_opcoes_personagem(null);
          ?>
        </select><br>
        <label for="">Usuário:</label><br>
        <select id="inserir_id_usuario">
          <option value="" selected disabled>-</option>
          <?php
            $opcoes = $personagemUsuario -> listar_opcoes_usuario(null);
          ?>
        </select><br>
...
<script src="js/personagem-usuario-controller.js"></script>
<?php 
  include "rodape.php";
?>