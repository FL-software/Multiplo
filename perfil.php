<?php
    ...
    class Perfil {
        ...
        public function inserir($Nome,$Descricao,$Ativo) {
            ...
            $consulta = "INSERT INTO Perfil (Nome, Descricao, Ativo) VALUES ('$Nome', '$Descricao', $Ativo)";
        ...
        public function excluir($ID) {
            ...
            $consulta = "UPDATE Perfil SET Ativo = 0 WHERE ID = $ID";
        ...
        public function alterar($ID, $Nome, $Descricao, $Ativo) {
            ...
            $consulta = "UPDATE Perfil SET Nome = '$Nome', Descricao = '$Descricao', Ativo = $Ativo WHERE ID = $ID";
