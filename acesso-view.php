  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select id="inserir_id_perfil">
          <option value="" selected disabled>-</option>
          <?php
            $opcoes = $acesso -> listar_opcoes_perfil(null);
          ?>
        </select><br>
        <label for="">Menu:</label><br>
        <select id="inserir_id_menu">
          <option value="" selected disabled>-</option>
          <?php
            $opcoes = $acesso -> listar_opcoes_menu(null);
          ?>
        </select><br>
...
<script src="js/acesso-controller.js"></script>
<?php 
  include "rodape.php";
?>