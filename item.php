<?php
    ...
    class Item {
        public function listar() {
            ...
            $consulta = "SELECT * FROM Item order by ID";
        ...
        public function inserir($Nome,$Descricao,$Ativo) {
            ...
            $consulta = "INSERT INTO Item (Nome, Descricao, Ativo) VALUES ('$Nome', '$Descricao', $Ativo)";
        ...
        public function excluir($ID) {
            ...
            $consulta = "UPDATE Item SET Ativo = 0 WHERE ID = $ID";
        ...
        public function alterar($ID, $Nome, $Descricao, $Ativo) {
            ...
            $consulta = "UPDATE Item SET Nome = '$Nome', Descricao = '$Descricao', Ativo = $Ativo WHERE ID = $ID";
