  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">        
        ...
        <input id="inserir_login" type="text"><br>
        <label for="">Senha:</label><br>
        <input id="inserir_senha" type="password"><br>
        <label for="">Perfil:</label><br>
        <select id="inserir_id_perfil">
          <option value="" selected disabled>-</option>
          <?php
            $opcoes = $usuario -> listar_opcoes_perfil(null);
          ?>
        </select><br>
...
<script src="js/usuario-controller.js"></script>
<?php 
  include "rodape.php";
?>