    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select id="inserir_id_personagem_usuario">
          ...
          <?php
            $opcoes = $participacao -> listar_opcoes_personagem_usuario(null);
          ?>
        </select><br>
        <label for="">Partida:</label><br>
        <select id="inserir_id_partida">
          <option value="" selected disabled>-</option>
          <?php
            $opcoes = $participacao -> listar_opcoes_partida(null);
          ?>
        </select><br>
...
<script src="js/participacao-controller.js"></script>
<?php 
  include "rodape.php";
?>