<?php
    ...
    class Tabuleiro {
        public function listar() {
            ...
            $consulta = "SELECT * FROM Tabuleiro order by ID";
        ...
        public function inserir($Nome, $Descricao, $Ativo, $IDJogo) {
            ...
            $consulta = "INSERT INTO Tabuleiro (Nome, Descricao, Ativo, IDJogo) VALUES ('$Nome', '$Descricao', $Ativo, $IDJogo)";
        ...
        public function excluir($ID) {
            ...
            $consulta = "UPDATE Tabuleiro SET Ativo = 0 WHERE ID = $ID";
        ...
        public function selecionar($ID) {
            ...
            $consulta = "SELECT * FROM Tabuleiro WHERE ID = $ID";
        ...
        public function alterar($ID, $Nome, $Descricao, $Ativo, $IDJogo) {
            ...
            $consulta = "UPDATE Tabuleiro SET Nome = '$Nome', Descricao = '$Descricao', Ativo = $Ativo, IDJogo = $IDJogo WHERE ID = $ID";
